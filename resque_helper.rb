    ...
    def migrate_subscriptions(params)
        ...
        my_subs.each do |sub|
            ...
            if my_prod_var['staging_product_id'] != "nothing"
                ...
                if !my_customer.billing_province.nil? && my_customer.billing_province != ""
